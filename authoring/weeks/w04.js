...
module.exports = {
  ...
  vocab: [
    ...
    { de: 'spannend',     en: 'exciting',     ru: 'захватывающий',   ua: 'захоплюючий' },
    ...
    { de: 'müssen',       en: 'must, to have to',          ru: 'быть должным, вынужденным',  ua: 'мусити, бути змушеним' },
    { de: 'dürfen',       en: 'may, to be allowed to',     ru: 'мочь (иметь разрешение)',    ua: 'могти (мати дозвіл)' },
    { de: 'sollen',       en: 'should, to be supposed to', ru: 'быть должным (по указанию)', ua: 'мати (за вказівкою)' },
  ...
  tasks: [
    ...
    { type: 'grammar', grammarFocus: 'dürfen / sollen / mögen (möchten)', drill: 'modalverben-2',
      text: { en: 'Learn dürfen, sollen and mögen/möchten and start the sentence bracket.',
              ru: 'Выучите dürfen, sollen и mögen/möchten и начните рамочную конструкцию.',
              ua: 'Вивчіть dürfen, sollen і mögen/möchten та почніть рамкову конструкцію.' } },
    ...
    { type: 'review', drill: 'satzklammer',
      text: { en: 'Review week 4, then give a one-minute spoken monologue about your hobbies.',
              ...
              ua: 'Повторіть тиждень 4, потім виголосіть уголос хвилинний монолог про свої хобі.' } },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      { speaker: 'A', de: 'Nein, nicht so gut. Wollen wir am Samstag ins Museum gehen?' },
    ...
    questions: [
      ...
      { de: 'Sie wollen am Samstag ins Museum gehen.', answer: true, text: { en: 'They want to go to the museum on Saturday.', ru: 'В субботу они хотят пойти в музей.', ua: 'У суботу вони хочуть піти в музей.' } },
    ],
  },
};
