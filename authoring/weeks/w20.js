...
module.exports = {
  ...
  tasks: [
    ...
    { type: 'listen',
      text: { en: 'Listen to the dialogue "Im Kleidungsgeschäft" and answer the true/false questions. Note how anziehen/ausziehen (put on / take off clothes) differs from the reflexive sich anziehen (get dressed).',
              ru: 'Прослушайте диалог «Im Kleidungsgeschäft» и ответьте на вопросы верно/неверно. Обратите внимание, чем anziehen/ausziehen (надевать/снимать вещь) отличается от возвратного sich anziehen (одеваться).',
              ua: 'Прослухайте діалог «Im Kleidungsgeschäft» і дайте відповіді правда/неправда. Зверніть увагу, чим anziehen/ausziehen (вдягати/знімати річ) відрізняється від зворотного sich anziehen (одягатися).' } },
    { type: 'write',
