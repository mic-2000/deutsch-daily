...
module.exports = {
  ...
  vocab: [
    ...
    { de: "aufwachsen",     en: "to grow up",            ru: "расти",                  ua: "рости" },
    { de: "die Kindheit",   en: "childhood",             ru: "детство",                ua: "дитинство" },
    { de: "die Jugend",     en: "youth",                 ru: "юность",                 ua: "молодість" },
    { de: "heiraten",       en: "to get married",        ru: "жениться, выходить замуж", ua: "одружуватися" },
    { de: "studieren",      en: "to study at university", ru: "учиться в вузе",         ua: "навчатися у вузі" },
    { de: "der Beruf",      en: "profession",            ru: "профессия",              ua: "професія" },
    { de: "sterben",        en: "to die",                ru: "умирать",                ua: "вмирати" },
  ...
  tasks: [
    ...
    { type: "listen", grammarFocus: "tense rule: Perfekt vs Präteritum",
      text: { en: "Listen to a birthday dialogue. Learn the rule: Perfekt is common in speech, Präteritum in written narrative — and sein, haben and modal verbs are usually used in Präteritum in everyday speech.",
              ru: "Прослушайте диалог о дне рождения. Запомните правило: Perfekt часто употребляется в устной речи, Präteritum — в письменном повествовании, а sein, haben и модальные обычно употребляются в Präteritum и в повседневной речи.",
              ua: "Прослухайте діалог про день народження. Запам'ятайте правило: Perfekt часто вживається в усному мовленні, Präteritum — у письмовій розповіді, а sein, haben і модальні зазвичай уживаються в Präteritum і в повсякденному мовленні." } },
    { type: "write",
  ...
  drills: {
    ...
    "praeteritum-modalverben": {
      ...
      items: [
        ...
        { type: "cloze",  de: "Sie ___ jeden Tag um sechs aufstehen. (müssen)", answer: "musste" },
        { type: "choice", de: "Als Kind ___ er nicht lange fernsehen. (dürfen)", answer: "durfte", options: ["durfte", "durfen", "darfte"] },
      ],
    },
  },
  ...
  dialogue: {
    ...
    lines: [
      ...
      { speaker: "B", de: "Hallo Max! Sie war wunderbar. Viele Freunde kamen und wir feierten lange." },
      { speaker: "A", de: "Hattest du schöne Geschenke?" },
      { speaker: "B", de: "Ja, meine Eltern schenkten mir ein Buch. Das war das beste Geschenk." },
    ...
    questions: [
      ...
      { de: "Lenas Eltern schenkten ihr ein Buch.", answer: true, text: { en: "Lena's parents gave her a book.", ru: "Родители подарили Лене книгу.", ua: "Батьки подарували Лені книжку." } },
