...
module.exports = {
  ...
  grammar:    { en: 'Passive present/past + man-sentences; modal passive; lassen + infinitive; von/durch', ru: 'Passiv Präsens/Präteritum + man-Sätze; Modalpassiv; lassen + Infinitiv; von/durch', ua: 'Passiv Präsens/Präteritum + man-Sätze; Modalpassiv; lassen + Infinitiv; von/durch' },
  ...
  vocab: [
    ...
    { de: 'produzieren',   en: 'to produce',       ru: 'производить',   ua: 'продукувати' },
    ...
    { de: 'bedienen',      en: 'to operate',       ru: 'управлять',     ua: 'керувати' },
  ...
  tasks: [
    ...
    { type: 'grammar', grammarFocus: 'lassen + infinitive; agent with von/durch', drill: 'passiv-agens',
      text: { en: 'Use lassen + infinitive (etwas reparieren lassen) and name the agent with von (person) or durch (means).',
              ru: 'Используйте lassen + инфинитив (etwas reparieren lassen) и указывайте деятеля через von (лицо) или durch (средство).',
              ua: 'Використовуйте lassen + інфінітив (etwas reparieren lassen) і вказуйте виконавця через von (особа) або durch (засіб).' } },
    { type: 'write',
  ...
  canDo: [
    ...
    { en: 'I can name the agent with von or durch and use lassen + infinitive.', ru: 'Я могу указать деятеля через von или durch и использовать lassen + инфинитив.', ua: 'Я можу вказати виконавця через von або durch і використовувати lassen + інфінітив.' },
